  ...
  return (
    <section className="flex size-full min-h-0 flex-col" aria-label="应用中心">
      ...
      <ManagementToolbar>
        ...
        <Button variant="outline" size="sm" onClick={() => setDialog("import")}><ImportIcon data-icon="inline-start" />导入</Button>
        <Button size="sm" onClick={() => setDialog("create")}><PlusIcon data-icon="inline-start" />新建应用</Button>
      </ManagementToolbar>
